...
import { ReadSitesPulseSubdomainsSectionResponse } from "../../../interfaces/pulse/sites";
...
export const readSitesPulseSubdomainsSection = async (ctx:CONTEXT,start:number,period:PERIODS) => {
	...
	*/
    ...
    return [
        {
            Subdominains: 'squintboard.com',
            Reach: 1324000,
            Page_Views: 24.36,
            Page_Views_Per_User: 3.4
        },
        {
            Subdominains: 'squintboard.com',
            Reach: 1324000,
