...
import { ReadSitesBenchAudienceSectionResponse } from "../../../interfaces/pulse/sites";
...
export const readSitesBenchAudienceSection = async (ctx:CONTEXT,start:number,period:PERIODS) => {
